...
This is from one of our collaborators and I don't actually understand what he's doing here. 
...
We can average age structure over 2007-2012 and use that as null age structure (as above).

We have no idea how age structure might change with the three treatments. Is there some way to simulate a bunch of different age structures? Maybe bounded by the observed data? 
...
We'd have about a 60% chance of rejecting null (i.e., concluding there was significant difference between age structures). 
